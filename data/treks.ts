...
export const treks: Trek[] = [
  {
    ...
    itinerary: [
      { day: 1, title: 'Dharamkot to Triund', description: 'Start 9 AM. Trek through dense forest 6 km to Snowline Café. Push through steep 3 km switchbacks to Triund. Camp, sunset, bonfire dinner.' },
