...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'How many days are enough?', answer: '3-5 days covers Triund trek, monastery visits, cafe hopping, and a day trip to Dharamkot or Naddi.' },
    ],
    meta_title: 'McLeod Ganj Guide - Best Hotels, Cafes & Things to Do | Dharamshala Stay',
    meta_description: 'Explore McLeod Ganj, the Little Lhasa of India. Top-rated hotels, must-visit cafes, Tibetan culture, and the best treks.',
  },
  {
    ...
    things_to_do: ['Visit Bhagsunag Temple', 'Hike to Bhagsu Waterfall', 'Enjoy a meal at Shiva Cafe', 'Attend a yoga class', 'Walk to Dharamkot through the forest'],
    image: UNSPLASH_IMAGES.bhagsu, image_alt: 'Bhagsu waterfall surrounded by green mountains', hotel_count: 28,
    faqs: [{ question: 'Is Bhagsu good for budget travellers?', answer: 'Absolutely. Guesthouses from ₹500-800/night. Many cafes serve filling meals under ₹200.' }],
    meta_title: 'Bhagsu Guide - Hotels, Waterfall & Cafes | Dharamshala Stay',
    meta_description: 'Discover Bhagsu near McLeod Ganj. Visit the ancient temple, hike to Bhagsu Waterfall, find budget stays, and enjoy the best cafes.',
  },
  {
    ...
    long_description: 'Perched at roughly 1,900 metres, Dharamkot is the starting point for the Triund trek and home to Tushita Meditation Centre. The village has a distinctly bohemian character with organic cafes, chai stalls, and guesthouses run by local families.',
    ...
    things_to_do: ['Start the Triund trek', 'Join a yoga retreat', 'Visit the Vipassana centre', 'Explore forest trails towards Gallu Devi', 'Enjoy sunset views from hilltop cafes'],
