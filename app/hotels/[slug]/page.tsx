        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            {hotel.rooms?.length > 0 && (
              <div>
                <h2 className="text-xl font-heading font-semibold mb-3">Room Types</h2>
                  ...
                  <div key={i} className="border border-slate-200 rounded-xl p-4 mb-3 flex items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-1">
                        {room.bed_type} · Max {room.max_occupancy} guests ·{' '}
                        {room.meal_plan === 'cp' ? 'Breakfast included' : room.meal_plan === 'map' ? 'Breakfast + Dinner' : room.meal_plan === 'ap' ? 'All meals' : 'Room only'}
                      </p>
                    </div>
                    <div className="text-right shrink-0">
                      <p className="text-lg font-bold">{formatPrice(room.base_price)}</p>
